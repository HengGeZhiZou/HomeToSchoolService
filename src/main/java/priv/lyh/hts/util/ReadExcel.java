    ...
    private List<Students> readExcelValue(Workbook wb){
        ...
        for(int r=1;r<totalRows;r++){
            ...
            for(int c = 0; c <this.totalCells; c++){
                ...
                if (cell != null){
                    if(c==0){
                        students.setStuName(cell.getStringCellValue());  //学生姓名
                    }else if(c==1){
                        students.setStuNum(cell.getStringCellValue());  //学生学号
                    }else if(c==2){
                        students.setStuSex(cell.getStringCellValue());  //学生性别
                    }else if(c==3){
                        students.setStuInstitute(cell.getStringCellValue());//学生学院
                    }else if(c==4){
                        students.setStuGrade(cell.getStringCellValue());//学生年级
                    }else if(c==5){
                        students.setStuMajor(cell.getStringCellValue());//学生专业
                    }else if(c==6){
                        students.setStuClass(cell.getStringCellValue());//学生班级
                    }
                }
